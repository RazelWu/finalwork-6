...
Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\20170114_kuas\WebApplication1\WebApplication1\App_Data\Database1.mdf;Integrated Security=True");
            connection.Open();
...
Select * from Album";
        ...
        public Models.Album GetAlbumByID(string id)
        {
           Models.Album result = new Models.Album();
            ...
            var connection = new System.Data.SqlClient.SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\20170114_kuas\WebApplication1\WebApplication1\App_Data\Database1.mdf;Integrated Security=True");
            connection.Open();
...
", id);
        ...
        public void UpdateAlbum(Models.Album updateAlbum)
        {
            ...
            command.CommandText = string.Format(@"
UPDATE          Album
SET             Genre='{1}',Title=N'{2}',Price=N'{3}',ImageUrl=N'{4}'
Where           ID='{0}'
